...
#include "stanExports_sample_fixedDispersion.h"

RCPP_MODULE(stan_fit4sample_fixedDispersion_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_sample_fixedDispersion")
