...
#include "stanExports_glm_pp_poisson.h"

RCPP_MODULE(stan_fit4glm_pp_poisson_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_glm_pp_poisson")
