...
namespace model_sample_hierarchical_poisson_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_sample_hierarchical_poisson");
    ...
    reader.add_event(175, 8, "restart", "model_sample_hierarchical_poisson");
    ...
    reader.add_event(238, 9, "restart", "model_sample_hierarchical_poisson");
    reader.add_event(282, 51, "end", "model_sample_hierarchical_poisson");
    return reader;
}
...
class model_sample_hierarchical_poisson
  : public stan::model::model_base_crtp<model_sample_hierarchical_poisson> {
private:
        int N;
        int K;
        vector_d y;
        ...
        vector_d shape;
public:
    model_sample_hierarchical_poisson(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_sample_hierarchical_poisson_namespace::model_sample_hierarchical_poisson";
        ...
        try {
            ...
            validate_non_negative_index("shape", "N", N);
            shape = Eigen::Matrix<double, Eigen::Dynamic, 1>(N);
            stan::math::fill(shape, DUMMY_VAR__);
            stan::math::assign(shape,multiply(lambda0, m0));
    ...
    ~model_sample_hierarchical_poisson() { }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                m = in__.vector_lb_constrain(0, N, lp__);
            else
                m = in__.vector_lb_constrain(0, N);
            // model body
            {
            ...
            lp_accum__.add(gamma_log(m, shape, lambda0));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_sample_hierarchical_poisson_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> m = in__.vector_lb_constrain(0, N);
        size_t m_j_1_max__ = N;
        for (size_t j_1__ = 0; j_1__ < m_j_1_max__; ++j_1__) {
    ...
    std::string model_name() const {
        return "model_sample_hierarchical_poisson";
    }
...
typedef model_sample_hierarchical_poisson_namespace::model_sample_hierarchical_poisson stan_model;
#ifndef USING_R
