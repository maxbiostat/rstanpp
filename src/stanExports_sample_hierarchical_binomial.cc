...
#include "stanExports_sample_hierarchical_binomial.h"

RCPP_MODULE(stan_fit4sample_hierarchical_binomial_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_sample_hierarchical_binomial")
