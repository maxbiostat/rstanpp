...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(152, 4, "restart", "model_glm_pp_poisson_post");
    ...
    reader.add_event(208, 5, "restart", "model_glm_pp_poisson_post");
    reader.add_event(279, 74, "end", "model_glm_pp_poisson_post");
    return reader;
}
