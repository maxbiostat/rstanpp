...
#include "stanExports_sample_randomDispersion.h"

RCPP_MODULE(stan_fit4sample_randomDispersion_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_sample_randomDispersion")
